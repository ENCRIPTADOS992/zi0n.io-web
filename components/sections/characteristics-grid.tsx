...
const characteristics = [
  ...
  {
    id: "3",
    title: "Sin actualizaciones push",
    description: "Ni la aplicación ni el sistema pueden recibir actualizaciones automáticas, evitando que terceros fuercen cambios no autorizados que comprometan la seguridad.",
    icon: RefreshCwOff,
    highlighted: false,
  },
  {
  ...
  },
  {
    ...
    description: "Zi0n crea un sistema fachada Android rotativa y oculta el sistema real dentro de una app de entrada. Esto permite despistar a terceros y proteger tu privacidad.",
    icon: EyeOff,
    highlighted: true,
  },
  {
  ...
  {
    id: "8",
    title: "Sin servidores ni almacenamiento de datos",
    description: "Zi0n no utiliza servidores con ubicaciones fijas ni almacena información de los dispositivos, garantizando que ningún dato pueda ser recuperado por terceros.",
    icon: ServerOff,
    highlighted: true,
  },
  {
    id: "9",
    title: "VPN dinámica descentralizada",
    description: "Zi0n emplea una VPN avanzada que opera sobre una red descentralizada, rotando constantemente la IP del sistema para maximizar la privacidad.",
    icon: Network,
    highlighted: false,
  },
  {
  ...
  },
  {
    ...
    description: "Analiza cada aplicación en busca de riesgos y clasifica su nivel de seguridad, engañando a la app con información falsa para proteger al usuario.",
    icon: ScanSearch,
    highlighted: false,
  },
  {
    ...
    description: "Zi0n puede vincularse con relojes inteligentes de sistema cerrado, permitiendo gestionar funciones clave del sistema de forma discreta y segura.",
    icon: Watch,
    highlighted: true,
  },  
]
