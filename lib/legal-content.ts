// Spanish content for Terms and Conditions (default)
  ...
  sections: [
    {
      ...
      content: `Los términos aquí previstos, se aceptan al escanear el QR para activar los Servicios. El Usuario declara haber leído y comprendido todas las cláusulas, asumiendo plena responsabilidad por su cumplimiento.`
    },
    {
      title: "2. Licencia",
      content: `2.1. Durante la vigencia y sujeto a estos Términos, la Empresa concede al Usuario una licencia limitada, mundial, no exclusiva, intransferible y revocable para usar el Software y Servicios, exclusivamente para fines lícitos de seguridad móvil y protección de datos. Cualquier uso fuera de este ámbito invalida la licencia automáticamente.

2.2. Sugestiones y Feedback: El Usuario concede a la Empresa, de forma irrevocable y perpetua, el derecho a usar sugerencias, comentarios o ideas proporcionadas por sus representantes, para mejorar, desarrollar o mercadear los Servicios, sin compensación alguna.

2.3. Prohibiciones: El Usuario no podrá: (i) sublicenciar, revender o distribuir los Servicios; (ii) realizar ingeniería inversa, descompilar o modificar el Software; (iii) usar los Servicios para fines ilícitos o que violen derechos de terceros.`
    },
    {
      title: "3. Conectividad",
      content: `3.1. Aunque se esfuerza por garantizar conectividad ideal, factores externos (como oscilaciones de operadores) pueden afectar el servicio. La Empresa no garantiza conectividad continua ni será responsable por pérdidas derivadas de instabilidades de terceros.

3.2. El Usuario es responsable de mantener una conexión estable y segura, eximiendo a la Empresa de cualquier interrupción causada por fallos en redes de terceros.`
    },
    {
...
4.3. El Usuario indemnizará a la Empresa por cualquier reclamo derivado de condiciones inseguras en sus instalaciones o incumplimientos regulatorios.`
    },
    {
      ...
      content: `Los Servicios se prestan bajo un modelo de suscripción recurrente. La suscripción inicia con la activación vía QR.
...
Cada Parte es responsable de sus tributos aplicables. Los cambios en legislación tributaria permitirán ajustes en los valores de la suscripción, con notificación previa de al menos 15 días. No hay reembolsos por periodos de suscripción ya iniciados o servicios prestados, salvo disposición expresa por ley imperativa.`
    ...
    {
      title: "6. Vigencia y Rescisión",
      content: `La vigencia de estos Términos y de los Servicios se determina por el término de adquisición, iniciando desde la Fecha de Inicio de la Licencia (activación vía QR) hasta la Fecha de Expiración de la Licencia adquirida.
...
15.6. Severabilidad: Si alguna disposición es declarada inválida, ilegal por autoridad competente, las restantes permanecerán vigentes, interpretándose para lograr el máximo efecto original.

15.7. Idioma y Interpretación: Estos Términos se redactan en español, que prevalece en caso de discrepancias con traducciones. Títulos y encabezados son para conveniencia y no afectan interpretación. Se interpretarán de buena fe, pero en caso de ambigüedad, a favor de la Empresa. Referencias a "incluyendo" no son limitativas.

15.8. Supervivencia: Cláusulas que por naturaleza sobreviven (ej. Confidencialidad, Propiedad Intelectual, Limitación de Responsabilidad, Disclaimer, Indemnizaciones, Conducta) permanecerán vigentes indefinidamente después de la terminación.

15.9. Relación entre Partes: Las Partes son contratistas independientes; nada crea agencia, sociedad, joint venture o empleo. Ninguna Parte representa a la otra ni incurre en obligaciones en su nombre.`
    },
    {
      title: "16. Legislación Aplicable",
      content: `Ley Gobernante: Estos Términos se rigen exclusivamente por las leyes de la República de Colombia, excluyendo reglas de conflictos de leyes o principios de derecho internacional privado que apliquen otra jurisdicción. Cualquier disputa se resolverá conforme al Código Civil, Código de Comercio y normativas específicas.`
    },
    {
      title: "17. Foro",
      content: `Jurisdicción Exclusiva: Cualquier disputa, controversia o reclamo derivado de o relacionado con estos Términos, su interpretación, ejecución, terminación o validez se resolverá exclusivamente en los tribunales competentes de Medellín, Antioquia, Colombia. El Usuario renuncia irrevocablemente a cualquier otro foro, jurisdicción o venue, incluyendo por conveniencia o forum non conveniens.`
    },
    {
      title: "18. Arbitraje Opcional",
      content: `A discreción de la Empresa, disputas podrán someterse a arbitraje vinculante bajo reglas de la Cámara de Comercio de Medellín, con un árbitro único, en español, en Medellín. La decisión arbitral será final y no apelable, con costos a cargo de la Parte perdedora.`
    },
    {
      title: "19. Medidas Cautelares",
      content: `Nada impide a la Empresa buscar medidas cautelares o provisionales en cualquier tribunal para proteger derechos, sin renuncia a arbitraje o jurisdicción.`
    }
  ],
  acceptance: `Al usar los Servicios, el Usuario confirma haber leído, comprendido y aceptado incondicionalmente estos Términos, sometiéndose a sus disposiciones.`
}

// Re-export language-specific content
...
export const termsContent: Record<string, typeof termsContentES> = {
  es: termsContentES,
  en: termsContentES, // English uses Spanish content as primary
  de: termsContentDE,
  fr: termsContentFR,
  it: termsContentIT,
  nl: termsContentNL,
...
export const legalNoticeContent: Record<string, {
  companyInfo: string
  contactEmail: string
  contactEmailSupport: string
  contactEmailLegal: string
  contactEmailLegalValue: string
  contactPhone: string
  contactAddress: string
  jurisdiction: string
  disclaimer: string
  intellectualPropertyText: string
  thirdPartyLinksText: string
  ...
  es: {
    ...
    contactPhone: '+57 300 929 1110',
    contactAddress: 'Calle 7 No. 39-215, Oficina 1009, Edificio Granahorrar, Medellín, Antioquia, Colombia',
    ...
    lastUpdateDate: '22 de diciembre de 2025',
    moreInfoText: 'Para más información, consulte los Términos y Condiciones de Uso y la Política de Tratamiento de Datos.',
  },
  en: {
    ...
    lastUpdateDate: 'December 22, 2025',
    moreInfoText: 'For more information, see the Terms and Conditions of Use and the Data Protection Policy.',
  },
}

// Cookies content
export const cookiesContent: Record<string, {
  intro: string
  privacyFocus: string
  section1: { title: string; description: string; types: { name: string; desc: string }[] }
  section2: { title: string; description: string; items: { label: string; text: string }[]; noCookies: string }
  section3: { title: string; description: string; items: { label: string; text: string }[] }
  section4: { title: string; description: string }
  section5: { title: string; description: string }
  section6: { title: string; description: string; responsible: string }
  footer: string
}> = {
  es: {
    intro: 'GLOBAL INVESTMENT ST S.A.S. (NIT 901206726-2, en adelante "la Empresa" o "Zi0n"), con domicilio en Calle 7 No. 39-215, Oficina 1009, Edificio Granahorrar, Medellín, Antioquia, Colombia, opera el sitio web https://www.zi0n.io/es (en adelante, "el Sitio"). Esta Política de Cookies explica cómo utilizamos cookies y tecnologías similares en el Sitio, en cumplimiento de la Ley 1581 de 2012 y normas relacionadas con la protección de datos en Colombia.',
    ...
    section1: {
      ...
      description: 'Las cookies son pequeños archivos de texto que se almacenan en su dispositivo (computadora, teléfono o tableta) cuando visita un sitio web. Pueden ser utilizadas para recordar preferencias, mejorar la experiencia de usuario o recopilar datos analíticos. Existen diferentes tipos:',
      types: [
        { name: 'Cookies esenciales', desc: 'Necesarias para el funcionamiento del sitio (ej. mantener sesiones).' },
        { name: 'Cookies de rendimiento', desc: 'Recopilan datos anónimos sobre el uso del sitio.' },
        { name: 'Cookies de funcionalidad', desc: 'Recuerdan elecciones del usuario (ej. idioma).' },
        { name: 'Cookies de publicidad', desc: 'Usadas para mostrar anuncios personalizados.' },
      ],
    },
    section2: {
      title: '2. Cookies Utilizadas en el Sitio',
      description: 'En Zi0n, priorizamos su privacidad y no recopilamos ni almacenamos datos de navegación más allá de lo esencial para proporcionar los Servicios. Por lo tanto:',
      items: [
        { label: 'No utilizamos cookies de terceros, analíticas ni de publicidad.', text: 'No compartimos datos con redes publicitarias, Google Analytics u otros servicios de tracking.' },
        { label: 'Cookies esenciales (si aplican):', text: 'Podríamos usar cookies técnicas temporales (de sesión) para funciones básicas como la navegación segura o el procesamiento del código QR para la instalación. Estas se eliminan automáticamente al cerrar el navegador y no recopilan datos personales identificables.' },
        { label: 'Datos recopilados:', text: 'Ninguno. No almacenamos información sobre su visita, IP, ubicación o comportamiento en el Sitio, salvo el correo electrónico proporcionado voluntariamente para registro o contacto.' },
      ],
      noCookies: 'Si el Sitio no usa cookies en absoluto (como en páginas estáticas sin scripts de tracking), no se instalará ninguna cookie en su dispositivo.',
    },
    section3: {
      title: '3. Gestión de Cookies',
      description: 'Usted puede controlar las cookies a través de la configuración de su navegador:',
      items: [
        { label: 'Bloquear o eliminar cookies:', text: 'La mayoría de los navegadores (como Chrome, Firefox, Safari) permiten rechazar cookies o eliminarlas. Consulte la sección de ayuda de su navegador para instrucciones.' },
        { label: 'Impacto:', text: 'Bloquear cookies esenciales podría afectar la funcionalidad del Sitio, como el escaneo de QR.' },
        { label: 'No usamos banners de consentimiento:', text: 'Dado que no usamos cookies no esenciales, no mostramos banners de cookies. Su navegación implica aceptación de esta Política.' },
      ],
    },
    section4: {
      title: '4. Enlaces a Terceros',
      description: 'El Sitio podría contener enlaces a sitios web de terceros (ej. procesadores de pago). Estos sitios tienen sus propias políticas de cookies, por las que no somos responsables. Revise sus políticas antes de interactuar.',
    },
    section5: {
      title: '5. Modificaciones a la Política',
      description: 'Nos reservamos el derecho de actualizar esta Política. Los cambios se publicarán en el Sitio y se notificarán por correo si aplica, con al menos 15 días de anticipación.',
    },
    section6: {
      title: '6. Contacto',
  ...
  en: {
    intro: 'GLOBAL INVESTMENT ST S.A.S. (NIT 901206726-2, hereinafter "the Company" or "Zi0n"), domiciled at Calle 7 No. 39-215, Oficina 1009, Edificio Granahorrar, Medellín, Antioquia, Colombia, operates the website https://www.zi0n.io/es (hereinafter, "the Site"). This Cookie Policy explains how we use cookies and similar technologies on the Site, in compliance with Law 1581 of 2012 and regulations related to data protection in Colombia.',
    privacyFocus: 'Given our focus on maximum privacy and not collecting unnecessary data, the Site does not use third-party cookies or tracking cookies. We only use strictly necessary cookies for the basic operation of the Site, if applicable.',
    section1: {
      title: '1. What are Cookies?',
      description: 'Cookies are small text files stored on your device (computer, phone or tablet) when you visit a website. They can be used to remember preferences, improve user experience or collect analytical data. There are different types:',
      types: [
        { name: 'Essential cookies', desc: 'Necessary for the site to function (e.g. maintaining sessions).' },
        { name: 'Performance cookies', desc: 'Collect anonymous data about site usage.' },
        { name: 'Functionality cookies', desc: 'Remember user choices (e.g. language).' },
        { name: 'Advertising cookies', desc: 'Used to display personalized ads.' },
      ],
    },
    section2: {
      title: '2. Cookies Used on the Site',
      description: 'At Zi0n, we prioritize your privacy and do not collect or store browsing data beyond what is essential to provide the Services. Therefore:',
      items: [
        { label: 'We do not use third-party, analytics, or advertising cookies.', text: 'We do not share data with advertising networks, Google Analytics or other tracking services.' },
        { label: 'Essential cookies (if applicable):', text: 'We may use temporary technical cookies (session) for basic functions such as secure browsing or QR code processing for installation. These are automatically deleted when you close your browser and do not collect personally identifiable data.' },
        { label: 'Data collected:', text: 'None. We do not store information about your visit, IP, location or behavior on the Site, except for the email voluntarily provided for registration or contact.' },
      ],
      noCookies: 'If the Site does not use cookies at all (as in static pages without tracking scripts), no cookie will be installed on your device.',
    },
    section3: {
      title: '3. Cookie Management',
      description: 'You can control cookies through your browser settings:',
      items: [
        { label: 'Block or delete cookies:', text: 'Most browsers (such as Chrome, Firefox, Safari) allow you to reject or delete cookies. Check your browser help section for instructions.' },
        { label: 'Impact:', text: 'Blocking essential cookies may affect Site functionality, such as QR scanning.' },
        { label: 'We do not use consent banners:', text: 'Since we do not use non-essential cookies, we do not display cookie banners. Your browsing implies acceptance of this Policy.' },
      ],
    },
    section4: {
      title: '4. Third-Party Links',
      description: 'The Site may contain links to third-party websites (e.g. payment processors). These sites have their own cookie policies for which we are not responsible. Review their policies before interacting.',
    },
    section5: {
      title: '5. Policy Changes',
      description: 'We reserve the right to update this Policy. Changes will be posted on the Site and notified by email if applicable, with at least 15 days advance notice.',
    },
    section6: {
      title: '6. Contact',
